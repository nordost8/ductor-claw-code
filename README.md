...
<p align="center"><strong>Ductor Claw Code fork</strong> — adds <code>claw</code> provider (open-source Claw Code CLI, <strong>cheap DeepSeek</strong>). <a href="SETUP.md"><strong>SETUP.md</strong></a> · <a href="FORK.md">FORK.md</a> · <a href="docs/UPSTREAM_SYNC.md"><strong>Upstream sync</strong></a> · <a href="GITHUB_SETUP.md">GITHUB_SETUP.md</a></p>
